  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.html"><img class="logo" src="<?=base_url()?>img/logo.jpg"></a></div>

        <div class="navbar-collapse collapse" style="height: 1px;">
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> Usuario
    ...
    <ul>
    <li><a href="<?=base_url()?>" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i> Dashboard<i class="fa fa-collapse"></i></a></li>
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="<?=base_url()?>"><span class="fa fa-caret-right"></span> Main</a></li>
    ...
    <li><a href="#" data-target=".mantenimientos-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i> Mantenimientos<i class="fa fa-collapse"></i></a></li>
        <li><ul class="mantenimientos-menu nav nav-list collapse">
